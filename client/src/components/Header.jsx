...
const Header = () => {
    ...
    >
        ...
        <motion.h1 className='text-4xl max-w-[490px] sm:text-6xl sm:max-w-
        [590px] mx-auto mt-5 text-center'>Turn text to <span className='text-blue-600'
        initial= {{opacity: 0}}
        animate = {{opacity: 1}}
        ...
        className='mt-5 text-neutral-600'> Generated images from Imager
